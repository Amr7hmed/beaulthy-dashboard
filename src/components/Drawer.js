  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubMenu key="2" icon={<FileWordOutlined />} title="Static Content">
          <Menu.Item key="/AddContent">
            <Link to="/AddContent">Create Content </Link>
          </Menu.Item>
        </SubMenu>

        <SubMenu key="3" icon={<AppstoreAddOutlined />} title="Products">
        ...
        <SubMenu key="4" icon={<ApartmentOutlined />} title="Categories">
        ...
        <SubMenu key="5" icon={<PercentageOutlined />} title="Discounts">
        ...
        <SubMenu key="9" icon={<UsergroupAddOutlined />} title="Permissions">
        ...
        <SubMenu key="14" icon={<SolutionOutlined />} title="Job Applications">
          <Menu.Item key="/JobApplications">
            <Link to="/JobApplications">Job Applications List </Link>
          </Menu.Item>
        </SubMenu>
